...
class SplitwiseReplicaScheduler(BaseReplicaScheduler):  # Define SplitwiseReplicaScheduler class inheriting from BaseReplicaScheduler
    ...
    def __init__(
        ...
        # TODO(tianhao909):  prompt/token task 
        ...
        # TODO(tianhao909):  pending_requests
    ...
    def _allocate_request(self, request: Request) -> None:  
        ...
        # 2 num_processed_tokens = 2048 +1 （p +1） + 1 （batch+1）
    ...
    # fth 260122 ； decode handle_event，event， event； 
    ...
    def _get_next_batch(self) -> Batch:
        ...
        if self.replica.replica_type == ReplicaType.MIXED:
            ...
            # batch end （）# （） #  batch end prequest p replica；  d replica； d replica
